  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          <Button variant="outline" onClick={showPayment ? () => setShowPayment(false) : onBack} className="mb-4">
            <ArrowLeft className="h-4 w-4 mr-2" />
            {showPayment ? "Back to Shipping" : "Back to Cart"}
          </Button>
              ...
              <>
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <form id="shipping-form" onSubmit={handleProceedToPayment}>
